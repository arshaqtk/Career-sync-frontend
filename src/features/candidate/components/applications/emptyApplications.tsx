  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center py-20 px-4 animate-in fade-in duration-500">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative h-20 w-20 bg-card border border-border/50 rounded-2xl flex items-center justify-center shadow-sm rotate-3">
      ...
      {/* Description */}
      <p className="max-w-sm text-muted-foreground text-[15px] leading-relaxed mb-8">
