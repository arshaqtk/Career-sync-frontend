...
import { useAddProfileExperience, useUpdateProfileExperience } from "../../hooks/useUpdateProfile";
...
export function ExperienceSection({ experience }: ExperienceSectionProps) {
  ...
  const handleExperienceSubmit=(payload:Experience)=>{
    ...
    if(!payload._id){
      ...
      updateExperience.mutate({payload,experienceId:payload._id})
      closeModal()
...
<div className="flex justify-end my-6">
         ...
         <ExperienceFormModal onSubmit={(payload) =>handleExperienceSubmit(payload)}/>
      {hasNoExperience ? (
